...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      {/* ===== Background Video ===== */} <div className="absolute inset-0 z-0 overflow-hidden">
         <video
      ...
      <div className="relative z-10 w-10/12 mx-auto text-center pt-28">
        ...
        >
          Performance Marketing & Data- <br />Driven
          
          Growth for UAE's Most <br /> Ambitious Brands
        </motion.h1>
        ...
        >
          ...
          At ABCD MEDIA UAE, we help ambitious <br /> brands scale profitably through
        ...
        >
          ...
          <Link
            href="#"
            className="px-12 py-4 rounded-full bg-[#a407d9] font-semibold hover:scale-105 transition duration-300"
          >
            Learn More
          </Link>
