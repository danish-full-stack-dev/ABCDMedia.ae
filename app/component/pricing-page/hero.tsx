...
export default function Hero() {
  return (
    <section
      ...
      style={{ minHeight: "50vh", background: "#0a0010" }}
    >
      {/* ===== Background Image ===== */}
      ...
      >
        ...
        <motion.h1
          ...
          className="text-3xl font-semibold leading-[1.2] text-center -mt-14"
        >
      ...
      <div className="relative z-10 w-11/12 max-w-7xl mx-auto hidden md:flex flex-row items-center justify-between gap-8 py-16 min-h-[70vh]">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-2xl">
          ...
          <motion.p
            ...
            className="text-gray-100 text-base leading-relaxed max-w-xl md:whitespace-nowrap"
          >
            Whether you're a budding startup or an established enterprise, we've crafted flexible plans tailored to fit every <br /> ambition. Dive in and discover the perfect package to skyrocket your success.
          </motion.p>
        </div>
