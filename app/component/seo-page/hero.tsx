  ...
  />
      ...
      <div className="relative z-10 w-11/12 max-w-7xl mx-auto flex flex-row items-center justify-between gap-8 py-16 min-h-[70vh]">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-2xl">
          ...
          >
            SEO is a Battleground. Are you <br /> ready to conquer?
          </motion.h1>
          ...
          >
            Our UK-Based team knows exactly what it takes to propel websites to the top of search <br /> engine rankings, what to spreak with our specialistdd?
          </motion.p>
        </div>
