      ...
      <div className="w-10/12 mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <motion.p
            ...
            className="text-[#9C27B0] font-medium tracking-widest uppercase text-xs md:text-sm mb-4"
          >
            Know ABCDMEDIA
          </motion.p>
          ...
          <motion.h2
            ...
            className="text-2xl lg:text-4xl font-bold text-black mb-6"
          >
            Did you know?
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-gray-600 text-sm md:text-base leading-relaxed max-w-xl mb-10"
          >
        ...
        >
          <div className="grid grid-cols-2">
            ...
            {/* BOX 1 */}
            <div className="p-5 md:p-10 border-r border-b border-gray-200">
              <h3 className="text-3xl lg:text-5xl font-bold text-[#9934C1] mb-2 md:mb-4">
                £2.1M
              </h3>
            ...
            {/* BOX 2 */}
            <div className="p-5 md:p-10 border-b border-gray-200">
              <h3 className="text-3xl lg:text-5xl font-bold text-[#9934C1] mb-2 md:mb-4">
                9.35x
              </h3>
              <p className="text-gray-700 text-xs md:text-base leading-relaxed">
            ...
            {/* BOX 3 */}
            <div className="p-5 md:p-10 border-r border-gray-200">
              <h3 className="text-3xl lg:text-5xl font-bold text-[#9934C1] mb-2 md:mb-4">
                +40%
              </h3>
              <p className="text-gray-700 text-xs md:text-base leading-relaxed">
