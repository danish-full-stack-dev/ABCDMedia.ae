  ...
  return (
    <section className="bg-white py-20 px-6">
      <div className="w-10/12 mx-auto">
        ...
        {/* Subtext */}
        <p className="text-center text-gray-700 text-base leading-relaxed max-w-2xl mx-auto mb-14">
          ...
          sectors. Some of our latest works are <br />related to Edtech, Fintech, Real
