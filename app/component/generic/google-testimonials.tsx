...
const TestimonialCard: React.FC<{ t: Testimonial }> = ({ t }) => (
  <div className="relative bg-white rounded-2xl p-5 md:p-7 shadow-sm border md:min-w-[50svh] min-w-[75vw] md:min-w-[50svh] border-gray-100 shrink-0 flex flex-col gap-3 md:gap-4 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-100/60 transition-all duration-300">
...
export const GoogleTestimonialsSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full pt-12 md:pt-20 pb-10 overflow-hidden bg-white">
